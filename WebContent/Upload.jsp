...
<body>
	...
	<div class="main-container" id="main-container">
		...
		<div class="page-header">
			<h2 class="widget-title grey lighter" align="center">
	 <i class="menu-icon fa fa-cloud-upload pink bigger-150"></i> File
				Uploads
			</h2>
		</div>
		<!-- /.page-header -->
						...
						<div class="widget-main padding-24">
							<div class="row">
								<div class="col-sm-5">
									<div class="row">
										<div
											class="col-xs-11 label label-lg label-danger arrowed-in arrowed-right">
										
											<a href="uploadform" role="button" class="menu-icon fa fa-cloud-upload grey bigger-150" >
									&nbsp; Single Upload &nbsp;
								</a>
								...
								<div class="col-sm-5">
									<div class="row">
										<div
											...
											<a href="uploadformmultiple" role="button" class="menu-icon fa fa-cloud-upload grey bigger-150" >
									&nbsp; Multiple Upload &nbsp;
								</a>
										</div>
									</div>
